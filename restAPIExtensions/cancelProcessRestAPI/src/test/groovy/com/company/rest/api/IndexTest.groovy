...
class IndexTest extends Specification {
    ...
    def should_return_a_json_representation_as_result() {
        ...
        httpRequest.getParameter("processInstanceId") >> "100"
        ...
        jsonResponse.processInstanceId == "100"
    ...
    def should_return_an_error_response_if_p_is_not_set() {
        ...
        httpRequest.getParameter("c") >> "aValue2"
        httpRequest.getParameter("processInstanceId") >> "aValue3"
    ...
    def should_return_an_error_response_if_processInstanceId_is_not_set() {
        given: "a request without processInstanceId"
        def index = new Index()
        httpRequest.getParameter("processInstanceId") >> null
        // Other parameters return a valid value
        httpRequest.getParameter("p") >> "aValue1"
        httpRequest.getParameter("c") >> "aValue2"
        ...
        // Validate returned response
        apiResponse.httpStatus == 400
        jsonResponse.error == "the parameter processInstanceId is missing"
    }
