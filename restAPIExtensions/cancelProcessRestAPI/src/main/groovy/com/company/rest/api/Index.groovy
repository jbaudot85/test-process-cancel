...
class Index implements RestApiController {
    ...
    RestApiResponse doHandle(HttpServletRequest request, RestApiResponseBuilder responseBuilder, RestAPIContext context) {
        ...
        // Retrieve processInstanceId parameter
		...
		context.apiClient.processAPI.cancelProcessInstance(processInstanceId.toLong());
		
        // Prepare the result
        def result = [ "p" : p ,"c" : c ,"processInstanceId" : processInstanceId , "myParameterKey" : paramValue, "currentDate" : LocalDate.now().toString() ]
